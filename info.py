...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002504641242'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003081477203'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-100')) 
auth_grp = environ.get('-1002763510524')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002733248821') 
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+yDYO_sht9302YTI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ackkfkdkc')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/+V8mKcjlSpkBkODk9')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/+O80MErDTOlE0NTY9')
...
SHORTENER_API = environ.get("SHORTENER_API", "39858c123770eee4696de29b889c1ccc80589233")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "v2links.de")
